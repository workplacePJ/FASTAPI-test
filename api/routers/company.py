...
async def list_company():
    return [company_schema.Company(id = 1, name = '株式会社トータルメディエイト', postal_code = '114-0052', address = '東京都北区上十条2-25-4', building_name = '榎本ビル', room_number = '所在階', tel = '03-5963-4880', fax = '03-5963-4881')]
